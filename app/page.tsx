...
const sites: Site[] = [
  { id:'a', title:'Boisko treningowe', address:'ul. Macieja Rataja, Zabrze', parcel:'1684/3, 1682/27', placement:'instalacja przy boisku treningowym', power:'do 50 kWp', lat:50.29503, lng:18.79772, images:['A.png'] },
  { id:'b', title:'GKS Walka Makoszowy', address:'ul. Jaskółcza 40, Zabrze', parcel:'1215/60 (dach) lub 1222/61, 2395/61 (teren)', placement:'dwie instalacje: na dachu lub na terenie', power:'2 × do 50 kWp', lat:50.28635, lng:18.78535, images:['B_1.png','B_2.png'] },
  { id:'c', title:'Powiatowy Urząd Pracy', address:'pl. Krakowski 9, Zabrze', parcel:'870/82', placement:'instalacja na budynku', power:'do 50 kWp', lat:50.30184, lng:18.78814, images:['C_1.png','C_2.png'] },
  { id:'d', title:'Budynek wielorodzinny', address:'ul. Legnicka 17, Zabrze', parcel:'1846/86', placement:'instalacja na budynku', power:'do 50 kWp', lat:50.26736, lng:18.76841, images:['D_1.png','D_2.png'] },
  { id:'e', title:'Hala Pogoń', address:'ul. Wolności 406, Zabrze', parcel:'4375/64', placement:'instalacja na budynku użyteczności publicznej', power:'do 50 kWp', lat:50.29644, lng:18.80581, images:['E_1.png','E_2.png'] },
  { id:'f', title:'Dom Harcerza', address:'ul. Wolności 350a, Zabrze', parcel:'4815/2', placement:'instalacja na budynku użyteczności publicznej', power:'do 50 kWp', lat:50.30149, lng:18.79572, images:['F_1.png'] },
  { id:'g', title:'Centrum Usług Społecznych', address:'ul. Stalmacha 7, Zabrze', parcel:'1034/78', placement:'instalacja na budynku użyteczności publicznej', power:'do 50 kWp', lat:50.30708, lng:18.79028, images:['G_1.png'] },
  { id:'h', title:'Ogrzewalnia', address:'ul. Stalmacha 7, Zabrze', parcel:'1034/78', placement:'instalacja na budynku użyteczności publicznej', power:'do 50 kWp', lat:50.30696, lng:18.79051, images:['H_1.png'] },
  { id:'i', title:'Punkt Obsługi Mieszkańców nr 1', address:'ul. 3 Maja 84, Zabrze', parcel:'875/35', placement:'instalacja na budynku wielorodzinnym', power:'do 50 kWp', lat:50.29114, lng:18.79193, images:['I_1.png','I_2.png'] },
  { id:'j', title:'Budynek użyteczności publicznej', address:'ul. Karola Miarki 5, Zabrze', parcel:'1741/107', placement:'instalacja na budynku', power:'do 50 kWp', lat:50.30863, lng:18.78460, images:['J_1.png','J_2.png'] },
];
